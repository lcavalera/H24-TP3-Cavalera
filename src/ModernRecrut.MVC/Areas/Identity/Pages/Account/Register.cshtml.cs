...
namespace ModernRecrut.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Le {0} doti être au moins {2} et au plus {1} characteres.", MinimumLength = 6)]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            ViewData["Types"] = new SelectList(Enum.GetValues<Data.Type>());
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Assigne le type candidat ou employé selon l'attribut EstEmploye, à la création du compte.
                if (Input.Type == Data.Type.Employe)
                {
                    user.Type = Data.Type.Employe;
                }
                else
                {
                    user.Type = Data.Type.Candidat; 
                }
                var result = await _userManager.CreateAsync(user, Input.Password);
                
                if (result.Succeeded)
                {
                    _logger.LogInformation("Utilisateur avec nouveau mot de pass créer.");
                    //Assigne le role candidat ou employé selon l'attribut EstEmploye, à la création du compte.
